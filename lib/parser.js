...
var Parser = function(number) {
    ...
    function parsePage(task, cb) {
        ...
        db.getInfoByPageId(url_id, function(error, info){
            ...
            workers.send({text:new Buffer(info.content,'binary'), site:meta.site, type:meta.type, date:date, url:meta.url}, function(error, match){
