...
var newClient = require('../lib/lib_mysql').newClient;

var db_client;

function _getInfoByPageId(dblink, page_id, cb) {
    dblink.fetchAll('SELECT * FROM page_content WHERE id='+page_id, function(error, rows) {
        if (error) {
