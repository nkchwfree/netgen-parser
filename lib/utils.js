...
exports.parseTaskURI = function(task) {
  ...
  var task_obj = { protocol : protocol, hostname : task_info.hostname, port : task_info.port, database : db_name, table : table_name, id : id, uri : task.uri, queue : task.queue };
  return task_obj;
};
